...
namespace Centauro.DigitalInvoice.BusinessLogic.Xades.Operations
{
    public abstract class XadesSignOperation
    {
        ...
        public static XmlDocument SignXML(XadesSignParameters parameters)
        {
            var xmlDSigParameters = CreateXmlDSigParametersFrom(parameters);
            return XmlDsigSignOperation.From(xmlDSigParameters).SignXML(xmlDSigParameters, signedXml => AddXAdESNodes(signedXml, xmlDSigParameters));
        }
