...
using Centauro.DigitalInvoice.BusinessLogic.Operations.Signers;
...
namespace Centauro.DigitalInvoice.BusinessLogic
{
    internal abstract class XmlDsigSignOperation
    {
        ...
        internal XmlDocument SignXML(XmlDsigSignParameters signParameters, Action<ExtendedSignedXml> signedXmlPostProcessing)
        {
            return SignAndGetXml(signParameters, signedXmlPostProcessing);
        }
        ...
        private ExtendedSignedXml GetSignature(XmlDocument inputXml, XmlDsigSignParameters signParameters, Action<ExtendedSignedXml> signedXmlPostProcessing)
        {
            ...
            signedXml.Signature.Id = "id-" + guid;
